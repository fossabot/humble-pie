...
class Template(object):
    ...
    def __load_from_header(self):
        ...
        self.created = datetime.datetime.strptime(self.header['createdAt'], '%Y-%m-%dT%H:%M:%S.%fZ') 
        self.updated = datetime.datetime.strptime(self.header['updatedAt'], '%Y-%m-%dT%H:%M:%S.%fZ')     
